        ...
        <div className='flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto md:backdrop-blur relative'> {/* Fix mx-auto */}
          ...
          <div className='hidden md:block'>
            <nav className='flex gap-8 text-sm'>
              <RouterLink  className='text-white/70 hover:text-white transition'> <ScrollLink to="features" smooth={true} duration={500}>Features</ScrollLink></RouterLink>
              <RouterLink  className='text-white/70 hover:text-white transition'>Developers</RouterLink>
              <RouterLink  className='text-white/70 hover:text-white transition'>Changelog</RouterLink>
              <RouterLink  className='text-white/70 hover:text-white transition'>Pricing</RouterLink>
            </nav>
          </div>
